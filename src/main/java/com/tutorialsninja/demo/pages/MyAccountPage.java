...
public class MyAccountPage extends Utility {
    ...
    public void fillInInformation(){
        sendTextToElement(firstName,"Avinashhhh");
        sendTextToElement(lastName,"Patelll");
        sendTextToElement(email,"aviiiinassshhhhpp@gmail.com");
        sendTextToElement(telephone,"07764523565");
    ...
    public void fillInEmailPassword(){
        sendTextToElement(email,"avinashp22@gmail.com");
        sendTextToElement(password,"Prime12345");
